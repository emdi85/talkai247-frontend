export function fetchhandleCallOutBound(payload) {
    return new Promise((resolve) => {
        ...
        fetch('https://bf45-188-43-253-77.ngrok-free.app/api/v1/phone/call-outbound', options)
...
export function fetchSetAssistant(payload) {
    return new Promise((resolve) => {
        ...
        fetch('https://bf45-188-43-253-77.ngrok-free.app/api/v1/phone/in-bound', options)
            .then(response => response.json())
            .then(response => resolve(response.data))
            .catch(err => console.error(err));
    })
...
export function fetchGetPhone(payload) {
    return new Promise((resolve) => {
        ...
        fetch('https://bf45-188-43-253-77.ngrok-free.app/api/v1/phone/get-phone', options)
            .then(response => response.json())
            .then(response => resolve(response.data))
            .catch(err => console.error(err));
    });
...
export function fetchBuyPhone(payload) {
    return new Promise((resolve) => {
        ...
        fetch('https://bf45-188-43-253-77.ngrok-free.app/api/v1/phone/buy-phone', options)
            .then(response => response.json())
